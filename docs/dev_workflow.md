...
2. **Create a Branch:**  
   Branch off from `develop` using a descriptive name (e.g., `feature/add-survey-logic`, `bugfix/fix-ui-error`).
3. **Commit & Push:**  
   Make small, focused commits with clear messages (conventional commits). Push your branch frequently.
4. **Open a Pull Request:**  
   Link the related issue in the PR description. Provide a summary of changes and request a review.
5. **Review & Merge:**  
...
- **Testing:** Verify changes locally and include tests where applicable.
